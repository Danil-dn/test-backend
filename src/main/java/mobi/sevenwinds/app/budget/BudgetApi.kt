...
fun NormalOpenAPIRoute.budget() {
    route("/budget") {
        route("/add").post<Unit, BudgetCreateRecordParams, BudgetCreateRecordParams>(info("Добавить запись")) { param, body ->
...
data class BudgetCreateRecordParams(
